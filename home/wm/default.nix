      ...
      modes = mkOption {
        type = with types; attrsOf (submodule {
          options = {
            ...
            bindings = mkOption {
              default = [];
              description = "Bindings for the mode.";
              type = listOf (submodule {
                options = {
                  ...
                  kind = mkOption {
                    ...
                    default = "raw";
                    description = ''
                      Kind of keybinding.  Can be:
                      - raw: `command` will be written as-is
                      - mode: switch to mode `description`, `command` will be ignored
                      - open: will `exec` the `command`, then switch to "default" mode
                    '';
                  };
                  description = mkOption {
                    type = str;
                    description = "Description shown in which-key of the key binding.";
                  };
                  command = mkOption {
                    type = nullOr str;
                    default = null;
                    description = "Command associated to the key binding.";
                  };
